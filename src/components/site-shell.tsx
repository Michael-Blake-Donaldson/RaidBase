...
export function SiteShell({
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(54,224,255,0.18),_transparent_32%),linear-gradient(180deg,#07111f_0%,#091425_45%,#050b14_100%)] text-slate-100">
      <div className="mx-auto flex min-h-screen max-w-[1600px] gap-6 px-4 py-4 lg:px-6">
        <aside className="hidden w-72 shrink-0 rounded-[28px] border border-white/10 bg-white/6 p-5 shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur xl:flex xl:flex-col">
          <div className="mb-8 flex items-center gap-3 rounded-2xl border border-cyan-400/20 bg-cyan-400/8 p-4">
            ...
            <div>
              <p className="font-display text-lg uppercase tracking-[0.3em] text-cyan-100">
                Raidbase
              </p>
          ...
          <div className="mt-auto space-y-4 rounded-[24px] border border-white/10 bg-slate-950/55 p-4">
        ...
        <main id="main-content" className="flex-1 rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(19,36,58,0.88)_0%,rgba(7,17,31,0.96)_100%)] shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur">
            ...
            <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
              ...
              <div className="grid gap-3 sm:grid-cols-2 xl:min-w-[360px]">
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                  <p className="text-xs uppercase tracking-[0.28em] text-slate-400">Live state</p>
                ...
                <div className="rounded-2xl border border-cyan-300/25 bg-cyan-300/10 p-4">
                  <p className="text-xs uppercase tracking-[0.28em] text-cyan-100">Next action</p>
          ...
          <MotionFade className="px-5 py-6 lg:px-8" delay={0.08}>
            {children}
          </MotionFade>
